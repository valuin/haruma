...
export default function SearchForm() {
  ...
  return (
    <Form className="w-3/5" action="/brands">
      <div className="relative">
        <label htmlFor="query" className="sr-only">
          Query
        </label>
        <Input defaultValue={searchParams.get('query') as string} className="peer pe-9 ps-9 bg-white" placeholder="Search..." type="search" name="query" id="query" />
